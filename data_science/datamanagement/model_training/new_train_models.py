...
# IMPORTANT: class must come from monotone_bundle.py
...
OUT_PATH = BASE_DIR / "mortality_multihorizon_model.joblib"
...
RANDOM_STATE = 42
TEST_SIZE = 0.2
CAL_METHOD = "isotonic"   # if unstable, use "sigmoid"
CAL_CV = 5
...
def main():
    ...
    for t in TARGET_COLS:
        cal = CalibratedClassifierCV(make_model(), method=CAL_METHOD, cv=CAL_CV)
    ...
    # quick sanity check (must be monotone)
