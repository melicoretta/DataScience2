...
print(df['MORTALITY_90DAY'].isnull().sum())
df['MORTALITY_90DAY'].value_counts()
...
# Split data
X = df.drop(['MORTALITY_180DAY', 'MORTALITY_INHOSPITAL', 'MORTALITY_90DAY', 'SUBJECT_ID','HADM_ID','ICUSTAY_ID'], axis=1)
y = df['MORTALITY_90DAY']
...
joblib.dump(final_model, "C:\\tu_project\\DataScience2\\data_science\\datamanagement\\static\\model\\XGBoost_mortality_90days.joblib")
